...
////////////////////////////////////////////////////////////
__IPPCP_INLINE void cpAES_CMAC(Ipp8u mac[MBS_RIJ128],
                               const Ipp8u* pSrc,
                               int len,
                               IppsAES_CMACState* pCtx)
{
    ippsAES_CMACUpdate(pSrc, len, pCtx);
    ippsAES_CMACFinal(mac, MBS_RIJ128, pCtx);
}
__IPPCP_INLINE IppStatus cpAES_S2V_init(Ipp8u v[MBS_RIJ128],
                                        const Ipp8u* pKey,
                                        int keyLen,
                                        IppsAES_CMACState* pCtx,
                                        int ctxSize)
...
__IPPCP_INLINE void cpAES_S2V_update(Ipp8u v[MBS_RIJ128],
                                     const Ipp8u* pSrc,
                                     int len,
                                     IppsAES_CMACState* pCtx)
{
...
static void cpAES_S2V_final(Ipp8u v[MBS_RIJ128],
                            const Ipp8u* pSrc,
                            int len,
                            IppsAES_CMACState* pCtx)
{

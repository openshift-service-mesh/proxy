                           ...
                           int64u work_buffer[][8])
{
    ...
    ifma_amm52x40_mb8((int64u*)red_X,
                      (int64u*)base,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);
...
#define SQUARE_5x52x40_mb4(out, Y, mod, k0) \
    AMS5x52x40_diagonal_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#else
#define SQUARE_5x52x40_mb4(out, Y, mod, k0)                                               \
    AMS52x40_diagonal_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));   \
                           ...
                           int64u work_buffer[][4])
{
    ...
    /* convert base into redundant domain */
    ifma_amm52x40_mb4((int64u*)red_X,
                      (int64u*)base,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);
    ...
    SQUARE_5x52x40_mb4((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
    SQUARE_5x52x40_mb4((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
    ifma_amm52x40_mb4((int64u*)red_Y,
                      (int64u*)red_Y,
                      (int64u*)red_X,
                      (int64u*)modulus,
                      (int64u*)k0);

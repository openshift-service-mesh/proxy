                  ...
                  int64u work_buffer[][8])
{
   ...
   */
    ...
    ifma_amm52x30_mb8((int64u*)red_table[0],
                      (int64u*)red_X,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);

    ifma_amm52x30_mb8((int64u*)red_table[1],
                      (int64u*)base,
                      (int64u*)toMont,
                      (int64u*)modulus,
                      (int64u*)k0);
    ...
    for (idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        SQUARE_52x30_mb8((int64u*)red_table[2 * idx],
                         (int64u*)red_table[idx],
                         (int64u*)modulus,
                         (int64u*)k0);
        ifma_amm52x30_mb8((int64u*)red_table[2 * idx + 1],
...
/* series of squaring */
            ...
            /* and multiply */
            ifma_amm52x30_mb8((int64u*)red_Y,
                              (int64u*)red_Y,
                              (int64u*)red_X,
                              (int64u*)modulus,
                              (int64u*)k0);
...
#define USE_AMS
#ifdef USE_AMS
#define SQUARE_52x30_mb4(out, Y, mod, k0) \
    AMS52x30_diagonal_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#else
#define SQUARE_52x30_mb4(out, Y, mod, k0) \
    ifma_amm52x30_mb4((int64u*)(out), (int64u*)(Y), (int64u*)(Y), (int64u*)(mod), (int64u*)(k0));
#endif
                  ...
                  int64u work_buffer[][4])
{
    ...
    */
    ...
    for (int idx = 1; idx < (1 << EXP_WIN_SIZE) / 2; idx++) {
        ...
        SQUARE_52x30_mb4((int64u*)red_table[2 * idx],
                         (int64u*)red_table[idx],
                         (int64u*)modulus,
                         (int64u*)k0);

        // redx_table[2*idx] = (base^(2*idx))*2^((LEN52/2)*DIGIT_SIZE) mod modulus
        ifma_ahmr52x30_mb4((int64u*)redx_table[2 * idx],
                           (int64u*)red_table[2 * idx],
                           (int64u*)modulus,
                           (int64u*)k0);
        ...
        ifma_ahmr52x30_mb4((int64u*)redx_table[2 * idx + 1],
    ...
    for (exp_bit_no -= EXP_WIN_SIZE; exp_bit_no >= 0; exp_bit_no -= EXP_WIN_SIZE) {
        ...
        AMS4x52x30_diagonal_stitched_with_extract_mb4((int64u*)red_Y,
                                                      (U64*)mulb,
                                                      (U64*)mulbx,
                                                      (int64u*)red_Y,
                                                      (int64u*)modulus,
        ...
        ifma_ahmm52x30_mb4((int64u*)red_Y,
                           (int64u*)red_Y,
                           (int64u*)mulb,
                           (int64u*)mulbx,
                           (int64u*)modulus,

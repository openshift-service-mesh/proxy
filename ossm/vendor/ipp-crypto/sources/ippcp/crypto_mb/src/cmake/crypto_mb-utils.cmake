...
macro(mbx_getlibversion VERSION_FILE)
    ...
    foreach(LINE ${FILE_CONTENTS})
        ...
        if ("${LINE}" MATCHES "#define +MBX_VER_PATCH")
            string(REGEX REPLACE "^#define +MBX_VER_PATCH +\([0-9]+\).*$" "\\1" MBX_VER_PATCH ${LINE})
        endif()
    ...
    endforeach()
    set(MBX_VER_FULL "${MBX_VER_MAJOR}.${MBX_VER_MINOR}.${MBX_VER_PATCH}")

...
/* clang-format off */
IPPFUN(IppStatus, ippsRSA_InitPrivateKeyType1, (int rsaModulusBitSize,
                                                int privateExpBitSize,
...
/* clang-format on */
{
    ...
    IPP_BADARG_RET(!((0 < privateExpBitSize) && (privateExpBitSize <= rsaModulusBitSize)),
                   ippStsBadArgErr);
    ...
    IPP_BADARG_RET(keyCtxSize < cpSizeof_RSA_privateKey1(rsaModulusBitSize, rsaModulusBitSize),
                   ippStsMemAllocErr);

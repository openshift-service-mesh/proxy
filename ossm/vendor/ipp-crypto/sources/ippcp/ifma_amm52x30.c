...
/* clang-format on */
{
    ...
    for (i = 0; i < 30; i++) {
        ...
        fma52x8lo_mem(R0, R0, Bi, a, 64 * 0) fma52x8lo_mem(R1, R1, Bi, a, 64 * 1)
            fma52x8lo_mem(R2, R2, Bi, a, 64 * 2) fma52x8lo_mem(R3, R3, Bi, a, 64 * 3)

                fma52x8lo_mem(R0, R0, Yi, m, 64 * 0) fma52x8lo_mem(R1, R1, Yi, m, 64 * 1)
                    fma52x8lo_mem(R2, R2, Yi, m, 64 * 2) fma52x8lo_mem(R3, R3, Yi, m, 64 * 3)

                        shift64_imm(R0, R0h, 1) shift64_imm(R0h, R1, 1) shift64_imm(R1, R1h, 1)
                            shift64_imm(R1h, R2, 1) shift64_imm(R2, R2h, 1) shift64_imm(R2h, R3, 1)
                                shift64_imm(R3, R3h, 1) shift64_imm(R3h, get_zero64(), 1)
        ...
        /* U = A*Bi (hi) */
        fma52x8hi_mem(R0, R0, Bi, a, 64 * 0) fma52x8hi_mem(R1, R1, Bi, a, 64 * 1)
            fma52x8hi_mem(R2, R2, Bi, a, 64 * 2) fma52x8hi_mem(R3, R3, Bi, a, 64 * 3)
            /* R += M*Yi (hi) */
            fma52x8hi_mem(R0, R0, Yi, m, 64 * 0) fma52x8hi_mem(R1, R1, Yi, m, 64 * 1)
                fma52x8hi_mem(R2, R2, Yi, m, 64 * 2) fma52x8hi_mem(R3, R3, Yi, m, 64 * 3)
    }

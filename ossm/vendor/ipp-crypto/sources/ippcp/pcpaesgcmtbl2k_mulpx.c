...
#if !((_IPP == _IPP_V8) || (_IPP == _IPP_P8) || (_IPP == _IPP_S8) || (_IPP >= _IPP_G9) || \
...
/* clang-format off */
IPP_OWN_DEFN(void, AesGcmMulGcm_table2K_ct, (Ipp8u* pGhash,
                                             const Ipp8u* pPrecomputeData,
                                             const void* pParam))
/* clang-format on */
{
    __ALIGN16 Ipp8u t5[BLOCK_SIZE];
...
IPP_OWN_DEFN(void,
             AesGcmMulGcm_table2K_ct,
             (Ipp8u * pHash, const Ipp8u* pPrecomputedData, const void* pParam))
{

...
*/
/* clang-format off */
IPP_OWN_DEFN(static BNU_CHUNK_T*, cpGFpxMul_pd_binom, (BNU_CHUNK_T* pR,
...
/* clang-format on */
{
    ...
    for (d = 1; d < deg; d++) {
        cpGFpxMul_GFE(X,
                      GFPX_IDX_ELEMENT(T0, deg - d, groundElemLen),
                      GFPX_IDX_ELEMENT(pB, d, groundElemLen),
                      pGFEx);
...
*/
/* clang-format off */
IPP_OWN_DEFN(static BNU_CHUNK_T*, cpGFpxSqr_pd_binom, (BNU_CHUNK_T* pR,
                                                       const BNU_CHUNK_T* pA,
                                                       gsEngine* pGFEx))
/* clang-format on */
{
...
static gsModMethod* gsPolyArith_binom(void)
{
    static gsModMethod m = {
        cpGFpxEncode_com, cpGFpxDecode_com, cpGFpxMul_pd_binom, cpGFpxSqr_pd_binom, NULL,
...
{
    static IppsGFpMethod method = { cpID_Binom, 0, NULL, NULL, NULL };

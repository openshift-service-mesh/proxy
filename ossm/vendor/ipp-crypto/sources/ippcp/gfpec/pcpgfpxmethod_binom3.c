...
*/
/* clang-format off */
IPP_OWN_DEFN(static BNU_CHUNK_T*, cpGFpxMul_p3_binom, (BNU_CHUNK_T* pR,
...
IPP_OWN_DEFN(static BNU_CHUNK_T*,
             cpGFpxSqr_p3_binom,
             (BNU_CHUNK_T * pR, const BNU_CHUNK_T* pA, gsEngine* pGFEx))
{
    gsEngine* pGroundGFE = GFP_PARENT(pGFEx);
    int groundElemLen    = GFP_FELEN(pGroundGFE);
...
static gsModMethod* gsPolyArith_binom3(void)
{
    static gsModMethod m = {
        cpGFpxEncode_com, cpGFpxDecode_com, cpGFpxMul_p3_binom, cpGFpxSqr_p3_binom, NULL,
...
{
    static IppsGFpMethod method = { cpID_Binom, 3, NULL, NULL, NULL };

...
IppStatus ippsSMS4EncryptCTR(const Ipp8u\* pSrc, Ipp8u\* pDst, int
len,const IppsSMS4Spec\* pCtx, Ipp8u\* pCtrValue , int ctrNumBitSize);
...
according to the CTR mode as specified in :term:`NIST SP 800-38A <[NIST SP 800-38A]>`.

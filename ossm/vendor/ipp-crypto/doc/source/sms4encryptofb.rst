...
Encrypts a variable length data stream using SMS4 block cipher in the
OFB mode.
...
IppStatus ippsSMS4EncryptOFB (const Ipp8u\* pSrc, Ipp8u\* pDst, int len,
int ofbBlkSize, const IppsSMS4Spec\* pCtx, Ipp8u\* pIV);
...
OFB mode as specified in :term:`NIST SP 800-38A <[NIST SP 800-38A]>`.
...
.. list-table:: 
   ...
   * -     ippStsUnderRunErr    
     -  Indicates an error condition if len is not divisible by the ofbBlkSize parameter value.
   * -     ippStsOFBSizeErr    

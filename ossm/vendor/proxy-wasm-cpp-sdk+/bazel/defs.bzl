...
_INTRINSICS_JS = Label("//:proxy_wasm_intrinsics_js")
...
def proxy_wasm_cc_binary(
    ...
    cc_binary(
        ...
        additional_linker_inputs = additional_linker_inputs + [_INTRINSICS_JS],
        linkopts = linkopts + [
            ...
            "--js-library=$(location {})".format(_INTRINSICS_JS),

...
all_requirements = ["@fuzzing_pip3//absl_py:pkg", "@fuzzing_pip3//six:pkg"]

all_whl_requirements_by_package = {"absl_py": "@fuzzing_pip3//absl_py:whl", "six": "@fuzzing_pip3//six:whl"}
...
def entry_point(pkg, script = None):
    if not script:
        script = pkg
    return "@fuzzing_pip3_" + pip_utils.normalize_name(pkg) + "//:rules_python_wheel_entry_point_" + script
